...
function [dY dati] = Atrial_SI_working(time, Y)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
g_K1 = 19.1925*.5;   % S_per_F (in i_K1) -- by multiplying by 4 you get no more spontaneous 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
i_stim_Amplitude = 5.5e-10;   % ampere (in stim_mode) 5.5e-10
